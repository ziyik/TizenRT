...
/**
  ...
  * @param  index_dir: select directout SPORT.
  */
void AUDIO_SP_SelDirectOutSource(u32 index_src, u32 index_dir)   //index_src:0   index_dir:2  
{
	AUDIO_SPORT_TypeDef* SPORTx_DIR = AUDIO_DEV_TABLE[index_dir].SPORTx;

	SPORTx_DIR->SP_DIRECT_CTRL0 &= ~(SP_MASK_TX_CH0_DATA_SEL | SP_MASK_TX_CH1_DATA_SEL | SP_MASK_TX_CH2_DATA_SEL | SP_MASK_TX_CH3_DATA_SEL | SP_MASK_TX_CH4_DATA_SEL
		| SP_MASK_TX_CH5_DATA_SEL | SP_MASK_TX_CH6_DATA_SEL | SP_MASK_TX_CH7_DATA_SEL);
	SPORTx_DIR->SP_DIRECT_CTRL0 |= (SP_TX_CH0_DATA_SEL(8) | SP_TX_CH1_DATA_SEL(8) | SP_TX_CH2_DATA_SEL(8) | SP_TX_CH3_DATA_SEL(8) | SP_TX_CH4_DATA_SEL(
		8) | SP_TX_CH5_DATA_SEL(8) | SP_TX_CH6_DATA_SEL(8) | SP_TX_CH7_DATA_SEL(8));

	SPORTx_DIR->SP_DIRECT_CTRL1 |= SP_BIT_DIRECT_REG_0_EN | SP_BIT_DIRECT_REG_1_EN | SP_BIT_DIRECT_REG_2_EN | SP_BIT_DIRECT_REG_3_EN;
	SPORTx_DIR->SP_DIRECT_CTRL2 |= SP_BIT_DIRECT_REG_4_EN | SP_BIT_DIRECT_REG_5_EN | SP_BIT_DIRECT_REG_6_EN | SP_BIT_DIRECT_REG_7_EN;

	SPORTx_DIR->SP_DIRECT_CTRL1 &= ~(SP_MASK_DIRECT_REG_0_SEL | SP_MASK_DIRECT_REG_1_SEL | SP_MASK_DIRECT_REG_2_SEL | SP_MASK_DIRECT_REG_3_SEL);
	SPORTx_DIR->SP_DIRECT_CTRL2 &= ~(SP_MASK_DIRECT_REG_4_SEL | SP_MASK_DIRECT_REG_5_SEL | SP_MASK_DIRECT_REG_6_SEL | SP_MASK_DIRECT_REG_7_SEL);

	switch (index_src) {
	case 0:
		SPORTx_DIR->SP_DIRECT_CTRL1 |= SP_DIRECT_REG_0_SEL(0) | SP_DIRECT_REG_1_SEL(1) | SP_DIRECT_REG_2_SEL(2) | SP_DIRECT_REG_3_SEL(3);
		SPORTx_DIR->SP_DIRECT_CTRL2 |= SP_DIRECT_REG_4_SEL(4) | SP_DIRECT_REG_5_SEL(5) | SP_DIRECT_REG_6_SEL(6) | SP_DIRECT_REG_7_SEL(7);
		break;
	...
	case 1:
		if (index_dir == 0) {
			...
			SPORTx_DIR->SP_DIRECT_CTRL1 |= SP_DIRECT_REG_0_SEL(8) | SP_DIRECT_REG_1_SEL(9) | SP_DIRECT_REG_2_SEL(0xa) | SP_DIRECT_REG_3_SEL(0xb);
			SPORTx_DIR->SP_DIRECT_CTRL2 |= SP_DIRECT_REG_4_SEL(0xc) | SP_DIRECT_REG_5_SEL(0xd) | SP_DIRECT_REG_6_SEL(0xe) | SP_DIRECT_REG_7_SEL(0xf);
		}
		break;

	case 2:
		if (index_dir == 3) {
			SPORTx_DIR->SP_DIRECT_CTRL1 |= SP_DIRECT_REG_0_SEL(0x10) | SP_DIRECT_REG_1_SEL(0x11) | SP_DIRECT_REG_2_SEL(0x12) | SP_DIRECT_REG_3_SEL(0x13);
			SPORTx_DIR->SP_DIRECT_CTRL2 |= SP_DIRECT_REG_4_SEL(0x14) | SP_DIRECT_REG_5_SEL(0x15) | SP_DIRECT_REG_6_SEL(0x16) | SP_DIRECT_REG_7_SEL(0x17);
		} else {
			SPORTx_DIR->SP_DIRECT_CTRL1 |= SP_DIRECT_REG_0_SEL(8) | SP_DIRECT_REG_1_SEL(9) | SP_DIRECT_REG_2_SEL(0xa) | SP_DIRECT_REG_3_SEL(0xb);
			SPORTx_DIR->SP_DIRECT_CTRL2 |= SP_DIRECT_REG_4_SEL(0xc) | SP_DIRECT_REG_5_SEL(0xd) | SP_DIRECT_REG_6_SEL(0xe) | SP_DIRECT_REG_7_SEL(0xf);
		}
